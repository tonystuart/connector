...
/**
 * A ContentPanel with no top border for use within TabPanel or for use
 * when containing a Grid. It should be used with setBodyBorder(true) which is
 * the default.
 */
public class NoTopBorderContentPanel extends ContentPanel
{
  @Override
  protected void onRender(com.google.gwt.user.client.Element parent, int pos)
  {
    ...
    if (component != null)
    {
      component.setStyleAttribute("borderBottom", "none");
    }
    ...
    if (component == null)
    {
      getBody().setStyleAttribute("borderTop", "none");
    }
  }
}
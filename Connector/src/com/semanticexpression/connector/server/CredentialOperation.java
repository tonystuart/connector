...
public class CredentialOperation extends BaseOperation
{

  public CredentialOperation(ServerContext serverContext)
  {
    super(serverContext);
  }

  public Credential getCredential(String authenticationToken)
  {
    Connection connection = repository.getConnectionPool().getConnection();
    try
    {
      return getCredential(connection, authenticationToken);
    }
    finally
    {
